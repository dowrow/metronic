							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div class="d-flex align-items-center gap-2 gap-lg-3">
									...
									<div class="m-0">
										...
										<!--end::Menu toggle-->
										<!--begin::Menu 1-->
										<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_61de0bc1436a2">
											<!--begin::Header-->
											<div class="px-7 py-5">
											...
											<div class="px-7 py-5">
												...
												<div class="mb-10">
													...
													<!--begin::Input-->
													<div>
														<select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_61de0bc1436a2" data-allow-clear="true">
															<option></option>
													...
													<div class="mb-10">
														...
														<div class="d-flex mb-10">
															...
															<div class="d-flex flex-column">
																...
																<div class="d-flex align-items-center mb-2">
																	<!--begin::Title-->
																	<a href="../../demo1/dist/apps/support-center/tickets/view.html" class="text-dark text-hover-primary fs-4 me-3 fw-bold">Admin theme npm issue</a>
																	<!--end::Title-->
																	<!--begin::Label-->
														...
														<div class="d-flex mb-10">
															...
															<div class="d-flex flex-column">
																...
																<div class="d-flex align-items-center mb-2">
																	<!--begin::Title-->
																	<a href="../../demo1/dist/apps/support-center/tickets/view.html" class="text-dark text-hover-primary fs-4 me-3 fw-bold">Admin theme authentication to node.js / strapi backend</a>
																	<!--end::Title-->
																	<!--begin::Label-->
														...
														<div class="d-flex mb-10">
															...
															<div class="d-flex flex-column">
																...
																<div class="d-flex align-items-center mb-2">
																	<!--begin::Title-->
																	<a href="../../demo1/dist/apps/support-center/tickets/view.html" class="text-dark text-hover-primary fs-4 me-3 fw-bold">How to use Admin theme with Django Framework?</a>
																	<!--end::Title-->
																	<!--begin::Label-->
														...
														<div class="d-flex mb-10">
															...
															<div class="d-flex flex-column">
																...
																<div class="d-flex align-items-center mb-2">
																	<!--begin::Title-->
																	<a href="../../demo1/dist/apps/support-center/tickets/view.html" class="text-dark text-hover-primary fs-4 me-3 fw-bold">Admin theme node.js / strapi backend</a>
																	<!--end::Title-->
																	<!--begin::Label-->
																	<span class="badge badge-light my-1">React</span>
																	<!--end::Label-->
