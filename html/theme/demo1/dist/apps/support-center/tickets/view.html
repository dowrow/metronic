							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div class="d-flex align-items-center gap-2 gap-lg-3">
									...
									<div class="m-0">
										...
										<!--end::Menu toggle-->
										<!--begin::Menu 1-->
										<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_61de0bc244bdc">
											<!--begin::Header-->
											<div class="px-7 py-5">
											...
											<div class="px-7 py-5">
												...
												<div class="mb-10">
													...
													<!--begin::Input-->
													<div>
														<select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_61de0bc244bdc" data-allow-clear="true">
															<option></option>
															...
															<div class="mb-10">
																...
																<div class="highlight">
																	...
																	<ul class="nav nav-pills" role="tablist">
																		<li class="nav-item">
																			<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_61de0bc247634" role="tab">JAVASCRIPT</a>
																		</li>
																		<li class="nav-item">
																			<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_61de0bc24763b" role="tab">HTML</a>
																		</li>
																	</ul>
																	<div class="tab-content">
																		<div class="tab-pane fade show active" id="kt_highlight_61de0bc247634" role="tabpanel">
...
setTimeout(function() {
    button.removeAttribute("data-kt-indicator");
																		...
																		<div class="tab-pane fade" id="kt_highlight_61de0bc24763b" role="tabpanel">
																			<div class="highlight-code">
																	...
																	<div class="w-100 d-flex flex-stack mb-8">
																		...
																		<div class="d-flex align-items-center f">
																			...
																			<div class="d-flex flex-column fw-bold fs-5 text-gray-600 text-dark">
																				...
																				<div class="d-flex align-items-center">
																					<!--begin::Username-->
																					<a href="../../demo1/dist/pages/user-profile/overview.html" class="text-gray-800 fw-bolder text-hover-primary fs-5 me-3">Sandra Piquet</a>
																					<!--end::Username-->
																					<span class="m-0"></span>
																				</div>
																				<!--end::Text-->
																	...
																	<div class="w-100 d-flex flex-stack mb-8">
																		...
																		<div class="d-flex align-items-center f">
																			...
																			<div class="d-flex flex-column fw-bold fs-5 text-gray-600 text-dark">
																				...
																				<div class="d-flex align-items-center">
																					<!--begin::Username-->
																					<a href="../../demo1/dist/pages/user-profile/overview.html" class="text-gray-800 fw-bolder text-hover-primary fs-5 me-3">Bob Clarcson</a>
																					<!--end::Username-->
																	...
																	<div class="w-100 d-flex flex-stack mb-8">
																		...
																		<div class="d-flex align-items-center f">
																			...
																			<div class="d-flex flex-column fw-bold fs-5 text-gray-600 text-dark">
																				...
																				<div class="d-flex align-items-center">
																					<!--begin::Username-->
																					<a href="../../demo1/dist/pages/user-profile/overview.html" class="text-gray-800 fw-bolder text-hover-primary fs-5 me-3">Matthew</a>
																					<!--end::Username-->
																					<span class="m-0"></span>
																				</div>
																				<!--end::Text-->
																	...
																	<div class="w-100 d-flex flex-stack mb-8">
																		...
																		<div class="d-flex align-items-center f">
																			...
																			<div class="d-flex flex-column fw-bold fs-5 text-gray-600 text-dark">
																				...
																				<div class="d-flex align-items-center">
																					<!--begin::Username-->
																					<a href="../../demo1/dist/pages/user-profile/overview.html" class="text-gray-800 fw-bolder text-hover-primary fs-5 me-3">Boris</a>
																					<!--end::Username-->
																					<span class="m-0"></span>
																				</div>
																				<!--end::Text-->
