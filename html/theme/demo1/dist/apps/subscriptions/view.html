							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div class="d-flex align-items-center gap-2 gap-lg-3">
									...
									<div class="m-0">
										...
										<!--end::Menu toggle-->
										<!--begin::Menu 1-->
										<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_61de0bd03bbfd">
											<!--begin::Header-->
											<div class="px-7 py-5">
											...
											<div class="px-7 py-5">
												...
												<div class="mb-10">
													...
													<!--begin::Input-->
													<div>
														<select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_61de0bd03bbfd" data-allow-clear="true">
															<option></option>
													...
													<table class="table align-middle table-row-dashed fs-6 text-gray-600 fw-bold gy-5" id="kt_table_customers_events">
														...
														<tbody>
															...
															<tr>
																...
																<a href="#" class="fw-bolder text-gray-800 text-hover-primary">7712-2792</a></td>
																<!--end::Event=-->
																<!--begin::Timestamp=-->
															...
															<tr>
																...
																<a href="#" class="fw-bolder text-gray-800 text-hover-primary">5970-9374</a></td>
																<!--end::Event=-->
																<!--begin::Timestamp=-->
															...
															<tr>
																...
																<a href="#" class="fw-bolder text-gray-800 text-hover-primary">1660-2544</a></td>
																<!--end::Event=-->
																<!--begin::Timestamp=-->
															...
															<tr>
																...
																<a href="#" class="fw-bolder text-gray-800 text-hover-primary me-1">8438-8152</a>status has changed from
																<span class="badge badge-light-warning me-1">Pending</span>to
																<span class="badge badge-light-info">In Progress</span></td>
																<!--end::Event=-->
																<!--begin::Timestamp=-->
																<td class="pe-0 text-gray-600 text-end min-w-200px">20 Dec 2022, 11:30 am</td>
																<!--end::Timestamp=-->
															</tr>
															<!--end::Table row-->
														</tbody>
