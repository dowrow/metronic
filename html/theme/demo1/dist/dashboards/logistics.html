						...
						<div class="toolbar" id="kt_toolbar">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Logistics</h1>
									<!--end::Title-->
								</div>
								<!--end::Page title-->
								<!--begin::Actions-->
										...
										<div class="card h-md-100">
											...
											<div class="card-body d-flex flex-column flex-center">
												...
												<div class="text-center">
													<!--begin::Link-->
													<a class="btn btn-sm btn-primary me-2" data-bs-toggle="tooltip" data-bs-dismiss="click" data-bs-custom-class="tooltip-dark" title="Logistics App is coming soon">Start Now</a>
													<!--end::Link-->
													<!--begin::Link-->
													<a class="btn btn-sm btn-light" data-bs-toggle="tooltip" data-bs-dismiss="click" data-bs-custom-class="tooltip-dark" title="Logistics App is coming soon">Quick Guide</a>
													<!--end::Link-->
												</div>
												<!--end::Links-->
											</div>
									...
									<div class="col-xl-8 mb-5 mb-xl-10">
										...
										<div class="row g-5 g-xl-10">
											...
											<div class="col-md-6 col-xl-6 mb-5 mb-xl-10">
												...
												<div class="card card-flush h-md-50 mb-5 mb-lg-10">
													<!--begin::Header-->
												...
												<ul class="nav nav-pills nav-pills-custom row position-relative mx-0 mb-9">
													...
													<li class="nav-item col-4 mx-0 px-0">
														...
														<a class="nav-link d-flex justify-content-center w-100 border-0 h-100" data-bs-toggle="pill" href="#kt_list_widget_10_tab_3">
															<!--begin::Subtitle-->
															<span class="nav-text text-gray-800 fw-bolder fs-6 mb-3">In Progress</span>
															<!--end::Subtitle-->
															<!--begin::Bullet-->
															<span class="bullet-custom position-absolute z-index-2 bottom-0 w-100 h-4px bg-primary rounded"></span>
															<!--end::Bullet-->
											...
											<div class="card-body pt-4">
												...
												<div class="d-flex flex-stack">
													...
													<div class="d-flex align-items-center me-5">
														...
														<div class="symbol symbol-40px me-4">
															<span class="symbol-label">
																<i class="fonticon-truck fs-1 p-0 text-600"></i>
															</span>
														</div>
														<!--end::Symbol-->
														<!--begin::Content-->
												...
												<div class="d-flex flex-stack">
													...
													<div class="d-flex align-items-center me-5">
														...
														<div class="symbol symbol-40px me-4">
															<span class="symbol-label">
																<i class="fonticon-offline fs-1 p-0 text-600"></i>
															</span>
														</div>
														<!--end::Symbol-->
														<!--begin::Content-->
												...
												<div class="d-flex flex-stack">
													...
													<div class="d-flex align-items-center me-5">
														...
														<div class="symbol symbol-40px me-4">
															<span class="symbol-label">
																<i class="fonticon-train fs-1 p-0 text-600"></i>
															</span>
														</div>
														<!--end::Symbol-->
														<!--begin::Content-->
