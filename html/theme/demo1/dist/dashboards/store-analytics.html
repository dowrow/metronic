										...
										<div class="card h-md-100">
											...
											<div class="card-body d-flex flex-column flex-center">
												...
												<div class="text-center">
													<!--begin::Link-->
													<a class="btn btn-sm btn-primary me-2" href="../../demo1/dist/apps/invoices/create.html">Try now</a>
													<!--end::Link-->
													<!--begin::Link-->
										...
										<div class="card card-flush h-md-100">
											...
											<div class="card-header py-7">
												...
												<div class="m-0">
													...
													<div class="d-flex align-items-center mb-2">
														<!--begin::Title-->
														<span class="fs-2hx fw-bolder text-gray-800 me-2 lh-1">0.37%</span>
														<!--end::Title-->
														<!--begin::Label-->
										...
										<div class="card card-flush h-xl-100">
											...
											<div class="card-body pt-5">
												...
												<div class="d-flex flex-stack">
													...
													<div class="d-flex align-items-center">
														<!--begin::Number-->
														<span class="text-gray-800 fw-bolder fs-6 me-3">794</span>
														<!--end::Number-->
														<!--begin::Info-->
														<div class="">
															<!--begin::Label-->
										...
										<div class="card card-flush h-xl-100">
											...
											<div class="card-body">
												...
												<div class="d-flex flex-stack">
													...
													<div class="d-flex align-items-center">
														<!--begin::Number-->
														<span class="text-gray-800 fw-bolder fs-6 me-3">1,067</span>
														<!--end::Number-->
														<!--begin::Info-->
														<div class="d-flex flex-center">
															<!--begin::label-->
												...
												<div class="d-flex flex-stack">
													...
													<div class="d-flex align-items-center">
														<!--begin::Number-->
														<span class="text-gray-800 fw-bolder fs-6 me-3">24,588</span>
														<!--end::Number-->
														<!--begin::Info-->
														<div class="d-flex flex-center">
															<!--begin::label-->
												...
												<div class="d-flex flex-stack">
													...
													<div class="d-flex align-items-center">
														<!--begin::Number-->
														<span class="text-gray-800 fw-bolder fs-6 me-3">6,578</span>
														<!--end::Number-->
														<!--begin::Info-->
														<div class="d-flex flex-center">
															<!--begin::label-->
												...
												<div class="d-flex flex-stack">
													...
													<div class="d-flex align-items-center">
														<!--begin::Number-->
														<span class="text-gray-800 fw-bolder fs-6 me-3">79,458</span>
														<!--end::Number-->
														<!--begin::Info-->
														<div class="d-flex flex-center">
															<!--begin::label-->
