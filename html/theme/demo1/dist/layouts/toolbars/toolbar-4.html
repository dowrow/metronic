								...
								<div class="d-flex align-items-center overflow-auto">
									...
									<div class="d-flex align-items-center">
										...
										<button type="button" class="btn btn-sm btn-icon btn-light" data-bs-toggle="tooltip" data-bs-placement="top" title="Enable row view">
											<!--SVG file not found: icons/duotune/finance/fin006.svgGrid-Horizontal.svg-->
										</button>
									</div>
									<!--end::Actions-->
								</div>
										...
										<div class="card card-xl-stretch">
											...
											<div class="card-header align-items-center border-0 mt-4">
												...
												<div class="card-toolbar">
													...
													<!--begin::Menu 1-->
													<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_61de0c30e6cbb">
														<!--begin::Header-->
														<div class="px-7 py-5">
														...
														<div class="px-7 py-5">
															...
															<div class="mb-10">
																...
																<!--begin::Input-->
																<div>
																	<select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_61de0c30e6cbb" data-allow-clear="true">
																		<option></option>
