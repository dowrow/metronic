...
&lt;/select&gt;</code>
									...
									<div class="py-10">
										...
										<!--begin::Block-->
										<div class="py-5">Use
										<code>&lt;optgroup&gt;</code>tag to group select options:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
...
&lt;/select&gt;</code>
									...
									<div class="py-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" id="input-group">
										<a href="#input-group"></a>Bootstrap Input Group</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Mix and match Select2 with
										<code>.input-group</code>
										<a href="https://getbootstrap.com/docs/5.1/forms/input-group" class="fw-bold">Bootstrap Input Group</a>&#160; components.</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
...
<code class="language-html">&lt;!--begin::Default example--&gt;
&lt;div class="input-group flex-nowrap"&gt;
...
&lt;div class="input-group input-group-solid flex-nowrap"&gt;
    ...
    &lt;span class="input-group-text"&gt;USD&lt;/span&gt;
&lt;/div&gt;
&lt;!--end::Both add-ons in solid style--&gt;</code>
</pre>
												</div>
											</div>
											<!--end::Highlight-->
...
&lt;/select&gt;</code>
									...
									<div class="py-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" id="dropdown-width">
										<a href="#dropdown-width"></a>Dropdown Width</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Use
										<a class="fw-bold" href="../../demo1/dist/documentation/base/utilities#width-and-height.html" target="_blank">Custom Width Classes</a>&#160; to set dropdown width via
										<code>data-dropdown-css-class="w-200px"</code>attribute:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<div class="highlight-code">
													<pre class="language-html">
<code class="language-html">&lt;select class="form-select form-select-solid" data-control="select2" data-dropdown-css-class="w-200px" data-placeholder="Select an option" data-hide-search="true"&gt;
    &lt;option&gt;&lt;/option&gt;
    &lt;option value="1"&gt;Option 1&lt;/option&gt;
    &lt;option value="2" selected&gt;Option 2&lt;/option&gt;
    &lt;option value="3"&gt;Option 3&lt;/option&gt;
...
&lt;!--end::Modal--&gt;</code>
									...
									<div class="py-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" id="countries">
										<a href="#countries"></a>Countries With Flags Example</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Initialize Select2 programmatically and add
										<code>data-kt-select2-country</code>attribute with the path to the country flag to create a list with country icons.</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
												<label for="" class="form-label">Select a country</label>
												<select class="form-select" data-placeholder="Select an option" id="kt_docs_select2_country">
													<option></option>
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<ul class="nav nav-pills" role="tablist">
													<li class="nav-item">
														<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_61de0b7680028" role="tab">JAVASCRIPT</a>
													</li>
													<li class="nav-item">
														<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_61de0b7680030" role="tab">HTML</a>
													</li>
												</ul>
												<div class="tab-content">
													<div class="tab-pane fade show active" id="kt_highlight_61de0b7680028" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-javascript" style="height:400px">
<code class="language-javascript">// Format options
const format = (item) =&gt; {
    if (!item.id) {
        return item.text;
    }
...
$('#kt_docs_select2_country').select2({
    templateResult: function (item) {
        return format(item);
													...
													<div class="tab-pane fade" id="kt_highlight_61de0b7680030" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-html" style="height:400px">
<code class="language-html">&lt;select class="form-select" placeholder="Select an option" id="kt_docs_select2_country"&gt;
    &lt;option&gt;&lt;/option&gt;
    &lt;option value="AF" data-kt-select2-country="flags/afghanistan.svg"&gt;Afghanistan&lt;/option&gt;
    &lt;option value="AX" data-kt-select2-country="flags/aland-islands.svg"&gt;Aland Islands&lt;/option&gt;
    ...
&lt;/select&gt;</code>
									...
									<div class="py-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" id="users">
										<a href="#users"></a>Users With Photos Example</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Initialize Select2 programmatically and add
										<code>data-kt-select2-user</code>attribute with the path to the user avatar to create a list with user portraits.</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
												<label for="" class="form-label">Select a user</label>
												<select class="form-select" data-placeholder="Select an option" id="kt_docs_select2_users">
													<option></option>
													<option value="0" data-kt-select2-user="avatars/300-6.jpg">Emma Smith</option>
													<option value="2" data-kt-select2-user="avatars/300-1.jpg">Max Smith</option>
													<option value="3" data-kt-select2-user="avatars/300-5.jpg">Sean Bean</option>
													<option value="4" data-kt-select2-user="avatars/300-25.jpg">Brian Cox</option>
													<option value="6" data-kt-select2-user="avatars/300-9.jpg">Francis Mitcham</option>
													<option value="9" data-kt-select2-user="avatars/300-23.jpg">Dan Wilson</option>
													<option value="11" data-kt-select2-user="avatars/300-12.jpg">Ana Crown</option>
													<option value="13" data-kt-select2-user="avatars/300-13.jpg">John Miller</option>
													<option value="15" data-kt-select2-user="avatars/300-21.jpg">Ethan Wilder</option>
												</select>
											</div>
										</div>
										<!--end::Block-->
										...
										<div class="pt-5">
											...
											<div class="highlight">
												...
												<ul class="nav nav-pills" role="tablist">
													<li class="nav-item">
														<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_61de0b768038f" role="tab">JAVASCRIPT</a>
													</li>
													<li class="nav-item">
														<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_61de0b7680393" role="tab">HTML</a>
													</li>
												</ul>
												<div class="tab-content">
													<div class="tab-pane fade show active" id="kt_highlight_61de0b768038f" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-javascript" style="height:400px">
<code class="language-javascript">// Format options
const format = (item) =&gt; {
...
$('#kt_docs_select2_country').select2({
    templateResult: function (item) {
        return format(item);
													...
													<div class="tab-pane fade" id="kt_highlight_61de0b7680393" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-html" style="height:400px">
<code class="language-html">&lt;select class="form-select" placeholder="Select an option" id="kt_docs_select2_users"&gt;
    &lt;option&gt;&lt;/option&gt;
    &lt;option value="0" data-kt-select2-user="avatars/300-6.jpg"&gt;Emma Smith&lt;/option&gt;
...
&lt;/select&gt;</code>
									...
									<div class="py-10">
										...
										<a href="https://getbootstrap.com/docs/5.1/forms/validation/" class="fw-bold">Bootstrap's Form Validation</a>&#160; classes are supported:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
