...
<html lang="en">
	<!--begin::Head-->
	<head><base href="../../../">
		<title>Fullcalendar Timezone Examples by Keenthemes</title>
		<meta charset="utf-8" />
										...
										<div class="pt-5">
											...
											<div class="highlight">
												...
												<ul class="nav nav-pills" role="tablist">
													<li class="nav-item">
														<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_61de0b8ed83da" role="tab">JAVASCRIPT</a>
													</li>
													<li class="nav-item">
														<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_61de0b8ed83e0" role="tab">HTML</a>
													</li>
												</ul>
												<div class="tab-content">
													<div class="tab-pane fade show active" id="kt_highlight_61de0b8ed83da" role="tabpanel">
...
const getFormat = (d) =&gt; {
    if(d.includes("T")){
        ...
        return "YYYY-MM-DD";
													...
													<div class="tab-pane fade" id="kt_highlight_61de0b8ed83e0" role="tabpanel">
														<div class="highlight-code">
