...
<html lang="en">
	<!--begin::Head-->
	<head><base href="../../">
		<title>Custom Bootstrap Stepper &amp; Wizard Component by Keenthemes</title>
		<meta charset="utf-8" />
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<ul class="nav nav-pills" role="tablist">
													<li class="nav-item">
														<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_61de0b9760494" role="tab">JAVASCRIPT</a>
													</li>
													<li class="nav-item">
														<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_61de0b976049a" role="tab">HTML</a>
													</li>
												</ul>
												<div class="tab-content">
													<div class="tab-pane fade show active" id="kt_highlight_61de0b9760494" role="tabpanel">
														<div class="highlight-code">
...
stepper.on("kt.stepper.previous", function (stepper) {
    stepper.goPrevious(); // go previous step
													...
													<div class="tab-pane fade" id="kt_highlight_61de0b976049a" role="tabpanel">
														<div class="highlight-code">
									...
									<div class="py-10">
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<ul class="nav nav-pills" role="tablist">
													<li class="nav-item">
														<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_61de0b976089c" role="tab">JAVASCRIPT</a>
													</li>
													<li class="nav-item">
														<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_61de0b976089f" role="tab">HTML</a>
													</li>
												</ul>
												<div class="tab-content">
													<div class="tab-pane fade show active" id="kt_highlight_61de0b976089c" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-javascript">
<code class="language-javascript">// Stepper lement
...
stepper.on("kt.stepper.previous", function (stepper) {
    stepper.goPrevious(); // go previous step
													...
													<div class="tab-pane fade" id="kt_highlight_61de0b976089f" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-html" style="height:400px">
<code class="language-html">&lt;!--begin::Stepper--&gt;
&lt;div class="stepper stepper-pills stepper-column d-flex flex-column flex-lg-row" id="kt_stepper_example_vertical"&gt;
									...
									<div class="py-10">
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<ul class="nav nav-pills" role="tablist">
													<li class="nav-item">
														<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_61de0b9760c6c" role="tab">JAVASCRIPT</a>
													</li>
													<li class="nav-item">
														<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_61de0b9760c6f" role="tab">HTML</a>
													</li>
												</ul>
												<div class="tab-content">
													<div class="tab-pane fade show active" id="kt_highlight_61de0b9760c6c" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-javascript">
<code class="language-javascript">// Stepper lement
...
stepper.on("kt.stepper.previous", function (stepper) {
    stepper.goPrevious(); // go previous step
													...
													<div class="tab-pane fade" id="kt_highlight_61de0b9760c6f" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-html" style="height:400px">
<code class="language-html">&lt;!--begin::Stepper--&gt;
&lt;div class="stepper stepper-pills" id="kt_stepper_example_clickable"&gt;
