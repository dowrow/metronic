												...
												<div id="kt_docs_search_handler_basic" data-kt-search-keypress="true" data-kt-search-min-length="2" data-kt-search-enter="true" data-kt-search-layout="inline">
													...
													<div class="py-5">
														...
														<div data-kt-search-element="empty" class="text-center d-none">
															...
															<!--begin::Illustration-->
															<div class="text-center px-4">
																<img class="mw-100 mh-200px" alt="image" src="assets/media/illustrations/sketchy-1/2.png" />
															</div>
															<!--end::Illustration-->
														</div>
														<!--end::Empty-->
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<ul class="nav nav-pills" role="tablist">
													<li class="nav-item">
														<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_61de0b964c4db" role="tab">JAVASCRIPT</a>
													</li>
													<li class="nav-item">
														<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_61de0b964c4e0" role="tab">HTML</a>
													</li>
												</ul>
												<div class="tab-content">
													<div class="tab-pane fade show active" id="kt_highlight_61de0b964c4db" role="tabpanel">
														<div class="highlight-code">
...
handleInput();</code>
													...
													<div class="tab-pane fade" id="kt_highlight_61de0b964c4e0" role="tabpanel">
														<div class="highlight-code">
...
&lt;!--end::Main wrapper--&gt;</code>
									...
									<div class="py-10">
										...
										<div class="py-5">
											<div class="rounded border p-5 p-lg-15">
												<!--begin::Search-->
												<div id="kt_docs_search_handler_menu" class="d-flex align-items-stretch" data-kt-search-keypress="true" data-kt-search-min-length="2" data-kt-search-enter="true" data-kt-search-layout="menu" data-kt-menu-trigger="auto" data-kt-menu-overflow="false" data-kt-menu-placement="bottom-start" data-kt-menu-permanent="true">
													<!--begin::Search toggle-->
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<ul class="nav nav-pills" role="tablist">
													<li class="nav-item">
														<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_61de0b964eb7e" role="tab">JAVASCRIPT</a>
													</li>
													<li class="nav-item">
														<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_61de0b964eb81" role="tab">HTML</a>
													</li>
												</ul>
												<div class="tab-content">
													<div class="tab-pane fade show active" id="kt_highlight_61de0b964eb7e" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-javascript" style="height:400px">
<code class="language-javascript">var processs = function(search) {
    var timeout = setTimeout(function() {
...
handleAdvancedOptionsForm();</code>
													...
													<div class="tab-pane fade" id="kt_highlight_61de0b964eb81" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-html" style="height:400px">
<code class="language-html">&lt;!--begin::Main wrapper--&gt;
									...
									<div class="py-10">
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<ul class="nav nav-pills" role="tablist">
													<li class="nav-item">
														<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_61de0b9650daf" role="tab">JAVASCRIPT</a>
													</li>
													<li class="nav-item">
														<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_61de0b9650db3" role="tab">HTML</a>
													</li>
												</ul>
												<div class="tab-content">
													<div class="tab-pane fade show active" id="kt_highlight_61de0b9650daf" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-javascript" style="height:400px">
<code class="language-javascript">var processs = function(search) {
    var timeout = setTimeout(function() {
...
preferencesDismissElement.addEventListener("click", function() {
    ...
    preferencesElement.classList.add("d-none");
													...
													<div class="tab-pane fade" id="kt_highlight_61de0b9650db3" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-html" style="height:400px">
<code class="language-html">&lt;!--begin::Main wrapper--&gt;
&lt;div
