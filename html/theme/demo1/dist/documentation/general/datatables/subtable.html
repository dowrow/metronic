							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
								...
								<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
									...
									<div class="menu-sub menu-sub-accordion">
										...
										<div class="menu-item">
											<a class="menu-link active py-2" href="../../demo1/dist/documentation/general/datatables/subtable.html">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
									...
									<div class="d-flex align-items-center" id="kt_docs_header_title">
										...
										<div class="docs-page-title d-flex flex-column flex-lg-row align-items-lg-center py-5 mb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_docs_content_container', 'lg': '#kt_docs_header_title'}">
											...
											<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-6 my-1">
												...
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item text-dark">Subtable</li>
												<!--end::Item-->
											</ul>
											<!--end::Breadcrumb-->
										</div>
						...
						<div class="container" id="kt_docs_content_container">
							...
							<div class="card card-docs mb-2">
								...
								<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
									...
									<div class="pt-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" id="subtable">
										<a href="#subtable"></a>Sub Datatable Example</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">This example shows the DataTables table with an expandable row. The sub-rows data are generated by using DataTable's template methods with simple JS data objects that can either be generated locally or retrieved from an API endpoint.</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<table class="table align-middle table-row-dashed fs-6 gy-4" id="kt_docs_datatable_subtable">
												...
												<tbody class="fw-bolder text-gray-600">
													...
													<tr>
														...
														<!--end::Order ID-->
														<!--begin::Crated date-->
														<td class="text-end">11 January 2022, 10:58 pm</td>
														<!--end::Created date-->
														<!--begin::Customer-->
														<td class="text-end">
													...
													<tr>
														...
														<!--end::Order ID-->
														<!--begin::Crated date-->
														<td class="text-end">11 January 2022, 10:06 pm</td>
														<!--end::Created date-->
														<!--begin::Customer-->
														<td class="text-end">
													...
													<tr>
														...
														<!--end::Order ID-->
														<!--begin::Crated date-->
														<td class="text-end">11 January 2022, 6:58 pm</td>
														<!--end::Created date-->
														<!--begin::Customer-->
														<td class="text-end">
													...
													<tr>
														...
														<!--end::Order ID-->
														<!--begin::Crated date-->
														<td class="text-end">10 January 2022, 10:58 pm</td>
														<!--end::Created date-->
														<!--begin::Customer-->
														<td class="text-end">
													...
													<tr>
														...
														<!--end::Order ID-->
														<!--begin::Crated date-->
														<td class="text-end">9 January 2022, 10:58 pm</td>
														<!--end::Created date-->
														<!--begin::Customer-->
														<td class="text-end">
													...
													<tr>
														...
														<!--end::Order ID-->
														<!--begin::Crated date-->
														<td class="text-end">8 January 2022, 10:58 pm</td>
														<!--end::Created date-->
														<!--begin::Customer-->
														<td class="text-end">
															<a href="" class="text-dark text-hover-primary">Brian Cox</a>
										...
										<div class="pt-5">
											...
											<div class="highlight">
												...
												<ul class="nav nav-pills" role="tablist">
													<li class="nav-item">
														<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_61de0b8626e69" role="tab">HTML</a>
													</li>
													<li class="nav-item">
														<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_61de0b8626e70" role="tab">JAVASCRIPT</a>
													</li>
												</ul>
												<div class="tab-content">
													<div class="tab-pane fade show active" id="kt_highlight_61de0b8626e69" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-html" style="height:400px">
<code class="language-html">&lt;table class="table align-middle table-row-dashed fs-6 gy-4" id="kt_docs_datatable_subtable"&gt;
 &lt;!--begin::Table head--&gt;
 &lt;thead&gt;
  &lt;!--begin::Table row--&gt;
  &lt;tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0"&gt;
...
&lt;/table&gt;</code>
													...
													<div class="tab-pane fade" id="kt_highlight_61de0b8626e70" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-javascript" style="height:400px">
<code class="language-javascript">var table;
var datatable;
var template;
 ...
 rows.forEach(r =&gt; {
  ...
  if (r.querySelector('[data-kt-docs-datatable-subtable="expand_row"]')) {
   r.querySelector('[data-kt-docs-datatable-subtable="expand_row"]').classList.remove('active');
		...
		<script src="assets/js/custom/documentation/general/datatables/subtable.js"></script>
