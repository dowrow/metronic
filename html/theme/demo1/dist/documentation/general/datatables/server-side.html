									...
									<div class="d-flex align-items-center" id="kt_docs_header_title">
										...
										<div class="docs-page-title d-flex flex-column flex-lg-row align-items-lg-center py-5 mb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_docs_content_container', 'lg': '#kt_docs_header_title'}">
											...
											<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-6 my-1">
												...
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item text-dark">Ajax Server Side</li>
												<!--end::Item-->
											</ul>
											<!--end::Breadcrumb-->
										</div>
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<ul class="nav nav-pills" role="tablist">
													<li class="nav-item">
														<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_61de0b859629a" role="tab">HTML</a>
													</li>
													<li class="nav-item">
														<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_61de0b85962a4" role="tab">JAVASCRIPT</a>
													</li>
													<li class="nav-item">
														<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_61de0b85962a7" role="tab">PHP</a>
													</li>
													<li class="nav-item">
														<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_61de0b85962a8" role="tab">PHP</a>
													</li>
												</ul>
												<div class="tab-content">
													<div class="tab-pane fade show active" id="kt_highlight_61de0b859629a" role="tabpanel">
...
&lt;!--end::Datatable--&gt;</code>
													...
													<div class="tab-pane fade" id="kt_highlight_61de0b85962a4" role="tabpanel">
														<div class="highlight-code">
...
KTUtil.onDOMContentLoaded(function () {
    KTDatatablesServerSide.init();
													...
													<div class="tab-pane fade" id="kt_highlight_61de0b85962a7" role="tabpanel">
														<div class="highlight-code">
...
$api-&gt;init();</code>
													...
													<div class="tab-pane fade" id="kt_highlight_61de0b85962a8" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-php" style="height:400px">
<code class="language-php">&lt;?php
/**
