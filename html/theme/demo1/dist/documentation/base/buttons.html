							...
							<div class="card card-docs mb-2">
								...
								<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
									...
									<div class="pb-10">
										...
										<a href="https://getbootstrap.com/docs/5.1/components/buttons/" class="fw-bold">Bootstrap Buttons</a>&#160; through the SASS variables in
										<code>src/sass/components/_variables.scss</code>and adds additonal options in
										<code>src/sass/components/buttons/</code>.</div>
										<!--end::Block-->
									</div>
									<!--end::Section-->
									<!--begin::Section-->
...
&lt;a href="#" class="btn btn-dark"&gt;Dark&lt;/a&gt;</code>
									...
									<div class="py-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" id="hover-effects">
										<a href="#hover-effects"></a>Hover Effects</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Use
										<code>.btn-hover-{effect}</code>class to set variouse hover effects for a button:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
												...
												<a href="#" class="btn btn-success btn-hover-rotate-end me-3">Rotate to end</a>
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<div class="highlight-code">
													<pre class="language-html">
<code class="language-html">&lt;a href="#" class="btn btn-primary btn-hover-rise me-5"&gt;Rise&lt;/a&gt;
...
&lt;a href="#" class="btn btn-warning btn-hover-rotate-start"&gt;Rotate to start&lt;/a&gt;</code>
</pre>
												</div>
											</div>
											<!--end::Highlight-->
...
&lt;a href="#" class="btn btn-active-icon-gray-900 btn-active-text-gray-900"&gt;&lt;span class="svg-icon svg-icon-1"&gt;&lt;svg&gt;...&lt;/svg&gt;&lt;/span&gt;Gray-900&lt;/a&gt;</code>
									...
									<div class="py-10">
										...
										<!--begin::Block-->
										<div class="py-5">Use
										<a href="../../demo1/dist/documentation/icons/duotune.html" class="fw-bold">Duotune Svg Icons</a>&#160;in conbination with buttons as shown below:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
...
&lt;a href="#" class="btn btn-icon btn-dark"&gt;&lt;span class="svg-icon svg-icon-1"&gt;&lt;svg&gt;...&lt;/svg&gt;&lt;/span&gt;&lt;/a&gt;</code>
										...
										<!--begin::Block-->
										<div class="py-5">Use
										<a href="../../demo1/dist/documentation/icons/bootstrap-icons.html" class="fw-bold">Bootstrap Icons</a>&#160;in conbination with buttons as shown below:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
...
&lt;a href="#" class="btn btn-icon btn-dark"&gt;&lt;i class="bi bi-chat-square-text-fill fs-4 me-2"&gt;&lt;/i&gt;&lt;/a&gt;</code>
										...
										<!--begin::Block-->
										<div class="py-5">Use
										<a href="../../demo1/dist/documentation/icons/font-awesome.html" class="fw-bold">Font Awesome Icons</a>&#160;in conbination with buttons as shown below:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
...
&lt;a href="#" class="btn btn-icon btn-dark"&gt;&lt;i class="fas fa-envelope-open-text fs-4 me-2"&gt;&lt;/i&gt;&lt;/a&gt;</code>
										...
										<!--begin::Block-->
										<div class="py-5">Use
										<a href="../../demo1/dist/documentation/icons/line-awesome.html" class="fw-bold">Line Awesome Icons</a>&#160;in conbination with buttons as shown below:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
