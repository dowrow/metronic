...
<html lang="en">
	<!--begin::Head-->
	<head><base href="../../">
		<title>Vector Illustrations by Keenthemes</title>
		<meta charset="utf-8" />
					...
					<div class="docs-aside-menu flex-column-fluid">
						...
						<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
								...
								<div class="menu-item">
									<a class="menu-link active py-2" href="../../demo1/dist/documentation/getting-started/illustrations.html">
									...
									<div class="d-flex align-items-center" id="kt_docs_header_title">
										...
										<div class="docs-page-title d-flex flex-column flex-lg-row align-items-lg-center py-5 mb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_docs_content_container', 'lg': '#kt_docs_header_title'}">
											...
											<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-6 my-1">
												...
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item text-dark">Illustrations</li>
												<!--end::Item-->
											</ul>
											<!--end::Breadcrumb-->
										</div>
								...
								<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
									...
									<div class="tab-content">
										...
										<div class="tab-pane fade show active" id="kt_illustration_sketchy-1">
											...
											<!--begin::More-->
											<div class="mb-5">
												<a href="https://keenthemes.com/products/sketchy-pro" class="btn btn-flex btn-link btn-color-primary">Learn more
											...
											<div class="row g-10">
												<div class="col-lg-4">
													...
													<div class="card overlay border">
														<div class="card-body p-0">
															<div class="overlay-wrapper h-300px bgi-no-repeat bgi-size-contain bgi-position-center" style="background-image:url('assets/media/illustrations/sketchy-1/1.png')"></div>
												...
												<div class="col-lg-4">
													...
													<div class="card overlay border">
														<div class="card-body p-0">
															<div class="overlay-wrapper h-300px bgi-no-repeat bgi-size-contain bgi-position-center" style="background-image:url('assets/media/illustrations/sketchy-1/2.png')"></div>
															<div class="overlay-layer card-rounded bg-dark bg-opacity-10 align-items-end pb-3">
																<!--begin::Path-->
												...
												<div class="col-lg-4">
													...
													<div class="card overlay border">
														<div class="card-body p-0">
															<div class="overlay-wrapper h-300px bgi-no-repeat bgi-size-contain bgi-position-center" style="background-image:url('assets/media/illustrations/sketchy-1/3.png')"></div>
															<div class="overlay-layer card-rounded bg-dark bg-opacity-10 align-items-end pb-3">
																<!--begin::Path-->
												...
												<div class="col-lg-4">
													...
													<div class="card overlay border">
														<div class="card-body p-0">
															<div class="overlay-wrapper h-300px bgi-no-repeat bgi-size-contain bgi-position-center" style="background-image:url('assets/media/illustrations/sketchy-1/4.png')"></div>
															<div class="overlay-layer card-rounded bg-dark bg-opacity-10 align-items-end pb-3">
																<!--begin::Path-->
												...
												<div class="col-lg-4">
													...
													<div class="card overlay border">
														<div class="card-body p-0">
															<div class="overlay-wrapper h-300px bgi-no-repeat bgi-size-contain bgi-position-center" style="background-image:url('assets/media/illustrations/sketchy-1/5.png')"></div>
															<div class="overlay-layer card-rounded bg-dark bg-opacity-10 align-items-end pb-3">
																<!--begin::Path-->
												...
												<div class="col-lg-4">
													...
													<div class="card overlay border">
														<div class="card-body p-0">
															<div class="overlay-wrapper h-300px bgi-no-repeat bgi-size-contain bgi-position-center" style="background-image:url('assets/media/illustrations/sketchy-1/6.png')"></div>
															<div class="overlay-layer card-rounded bg-dark bg-opacity-10 align-items-end pb-3">
																<!--begin::Path-->
												...
												<div class="col-lg-4">
													...
													<div class="card overlay border">
														<div class="card-body p-0">
															<div class="overlay-wrapper h-300px bgi-no-repeat bgi-size-contain bgi-position-center" style="background-image:url('assets/media/illustrations/sketchy-1/7.png')"></div>
															<div class="overlay-layer card-rounded bg-dark bg-opacity-10 align-items-end pb-3">
																<!--begin::Path-->
												...
												<div class="col-lg-4">
													...
													<div class="card overlay border">
														<div class="card-body p-0">
															<div class="overlay-wrapper h-300px bgi-no-repeat bgi-size-contain bgi-position-center" style="background-image:url('assets/media/illustrations/sketchy-1/8.png')"></div>
															<div class="overlay-layer card-rounded bg-dark bg-opacity-10 align-items-end pb-3">
																<!--begin::Path-->
												...
												<div class="col-lg-4">
													...
													<div class="card overlay border">
														<div class="card-body p-0">
															<div class="overlay-wrapper h-300px bgi-no-repeat bgi-size-contain bgi-position-center" style="background-image:url('assets/media/illustrations/sketchy-1/9.png')"></div>
															<div class="overlay-layer card-rounded bg-dark bg-opacity-10 align-items-end pb-3">
																<!--begin::Path-->
												...
												<div class="col-lg-4">
													...
													<div class="card overlay border">
														<div class="card-body p-0">
															<div class="overlay-wrapper h-300px bgi-no-repeat bgi-size-contain bgi-position-center" style="background-image:url('assets/media/illustrations/sketchy-1/10.png')"></div>
															<div class="overlay-layer card-rounded bg-dark bg-opacity-10 align-items-end pb-3">
																<!--begin::Path-->
												...
												<div class="col-lg-4">
													...
													<div class="card overlay border">
														<div class="card-body p-0">
															<div class="overlay-wrapper h-300px bgi-no-repeat bgi-size-contain bgi-position-center" style="background-image:url('assets/media/illustrations/sketchy-1/11.png')"></div>
															<div class="overlay-layer card-rounded bg-dark bg-opacity-10 align-items-end pb-3">
																<!--begin::Path-->
												...
												<div class="col-lg-4">
													...
													<div class="card overlay border">
														<div class="card-body p-0">
															<div class="overlay-wrapper h-300px bgi-no-repeat bgi-size-contain bgi-position-center" style="background-image:url('assets/media/illustrations/sketchy-1/12.png')"></div>
															<div class="overlay-layer card-rounded bg-dark bg-opacity-10 align-items-end pb-3">
																<!--begin::Path-->
												...
												<div class="col-lg-4">
													...
													<div class="card overlay border">
														<div class="card-body p-0">
															<div class="overlay-wrapper h-300px bgi-no-repeat bgi-size-contain bgi-position-center" style="background-image:url('assets/media/illustrations/sketchy-1/13.png')"></div>
															<div class="overlay-layer card-rounded bg-dark bg-opacity-10 align-items-end pb-3">
																<!--begin::Path-->
												...
												<div class="col-lg-4">
													...
													<div class="card overlay border">
														<div class="card-body p-0">
															<div class="overlay-wrapper h-300px bgi-no-repeat bgi-size-contain bgi-position-center" style="background-image:url('assets/media/illustrations/sketchy-1/14.png')"></div>
															<div class="overlay-layer card-rounded bg-dark bg-opacity-10 align-items-end pb-3">
																<!--begin::Path-->
												...
												<div class="col-lg-4">
													...
													<div class="card overlay border">
														<div class="card-body p-0">
															<div class="overlay-wrapper h-300px bgi-no-repeat bgi-size-contain bgi-position-center" style="background-image:url('assets/media/illustrations/sketchy-1/15.png')"></div>
															<div class="overlay-layer card-rounded bg-dark bg-opacity-10 align-items-end pb-3">
																<!--begin::Path-->
												...
												<div class="col-lg-4">
													...
													<div class="card overlay border">
														<div class="card-body p-0">
															<div class="overlay-wrapper h-300px bgi-no-repeat bgi-size-contain bgi-position-center" style="background-image:url('assets/media/illustrations/sketchy-1/16.png')"></div>
															<div class="overlay-layer card-rounded bg-dark bg-opacity-10 align-items-end pb-3">
																<!--begin::Path-->
												...
												<div class="col-lg-4">
													...
													<div class="card overlay border">
														<div class="card-body p-0">
															<div class="overlay-wrapper h-300px bgi-no-repeat bgi-size-contain bgi-position-center" style="background-image:url('assets/media/illustrations/sketchy-1/17.png')"></div>
															<div class="overlay-layer card-rounded bg-dark bg-opacity-10 align-items-end pb-3">
																<!--begin::Path-->
												...
												<div class="col-lg-4">
													...
													<div class="card overlay border">
														<div class="card-body p-0">
															<div class="overlay-wrapper h-300px bgi-no-repeat bgi-size-contain bgi-position-center" style="background-image:url('assets/media/illustrations/sketchy-1/18.png')"></div>
															<div class="overlay-layer card-rounded bg-dark bg-opacity-10 align-items-end pb-3">
																<!--begin::Path-->
												...
												<div class="col-lg-4">
													...
													<div class="card overlay border">
														<div class="card-body p-0">
															<div class="overlay-wrapper h-300px bgi-no-repeat bgi-size-contain bgi-position-center" style="background-image:url('assets/media/illustrations/sketchy-1/19.png')"></div>
															<div class="overlay-layer card-rounded bg-dark bg-opacity-10 align-items-end pb-3">
																<!--begin::Path-->
												...
												<div class="col-lg-4">
													...
													<div class="card overlay border">
														<div class="card-body p-0">
															<div class="overlay-wrapper h-300px bgi-no-repeat bgi-size-contain bgi-position-center" style="background-image:url('assets/media/illustrations/sketchy-1/20.png')"></div>
															<div class="overlay-layer card-rounded bg-dark bg-opacity-10 align-items-end pb-3">
																<!--begin::Path-->
