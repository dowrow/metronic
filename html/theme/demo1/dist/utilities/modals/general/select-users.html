											...
											<div class="menu-sub menu-sub-accordion menu-active-bg">
												<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
													...
													<div class="menu-sub menu-sub-accordion menu-active-bg">
														...
														<div class="menu-item">
															<a class="menu-link active" href="../../demo1/dist/utilities/modals/general/select-users.html">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
						...
						<div class="toolbar" id="kt_toolbar">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Select Friends</h1>
									<!--end::Title-->
									<!--begin::Separator-->
									...
									<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
										...
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item text-dark">Select Users</li>
										<!--end::Item-->
									</ul>
									<!--end::Breadcrumb-->
								</div>
								...
								<div class="d-flex align-items-center gap-2 gap-lg-3">
									...
									<div class="m-0">
										...
										<!--end::Menu toggle-->
										<!--begin::Menu 1-->
										<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_61de0bf2d25b4">
											<!--begin::Header-->
											<div class="px-7 py-5">
											...
											<div class="px-7 py-5">
												...
												<div class="mb-10">
													...
													<!--begin::Input-->
													<div>
														<select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_61de0bf2d25b4" data-allow-clear="true">
															<option></option>
								...
								<div class="card">
									...
									<div class="card-body">
										...
										<div class="card-px text-center pt-15 pb-15">
											<!--begin::Title-->
											<h2 class="fs-2x fw-bolder mb-0">Select Users Modal Example</h2>
											<!--end::Title-->
											<!--begin::Description-->
						...
						<div class="mh-475px scroll-y me-n7 pe-7">
							...
							<div class="border border-hover-primary p-7 rounded mb-7">
								...
								<div class="d-flex flex-stack pb-3">
									...
									<div class="d-flex">
										...
										<div class="ms-5">
											<!--begin::Name-->
											<div class="d-flex align-items-center">
												<a href="../../demo1/dist/pages/user-profile/overview.html" class="text-dark fw-bolder text-hover-primary fs-5 me-4">Emma Smith</a>
												<!--begin::Label-->
											...
											<!--end::Name-->
											<!--begin::Desc-->
											<span class="text-muted fw-bold mb-3">Art Director</span>
											<!--end::Desc-->
										</div>
										<!--end::Details-->
									</div>
									...
									<div clas="d-flex">
										...
										<div class="text-end pb-3">
											<span class="text-dark fw-bolder fs-5">$75.60</span>
								...
								<div class="p-0">
									...
									<div class="d-flex flex-column">
										<!--begin::Text-->
										<p class="text-gray-700 fw-bold fs-6 mb-4">First, a disclaimer - the entire process writing a blog post often takes more.</p>
										<!--end::Text-->
										<!--begin::Tags-->
							...
							<div class="border border-hover-primary p-7 rounded mb-7">
								...
								<div class="d-flex flex-stack pb-3">
									...
									<div class="d-flex">
										...
										<div class="ms-5">
											<!--begin::Name-->
											<div class="d-flex align-items-center">
												<a href="../../demo1/dist/pages/user-profile/overview.html" class="text-dark fw-bolder text-hover-primary fs-5 me-4">Sean Bean</a>
												<!--begin::Label-->
												<span class="badge badge-light-success d-flex align-items-center fs-8 fw-bold">
												<!--begin::Svg Icon | path: icons/duotune/general/gen029.svg-->
												<span class="svg-icon svg-icon-8 svg-icon-success me-1">
											...
											<!--end::Name-->
											<!--begin::Desc-->
											<span class="text-muted fw-bold mb-3">Project Manager</span>
											<!--end::Desc-->
										</div>
										<!--end::Details-->
									</div>
									...
									<div clas="d-flex">
										<!--begin::Price-->
										<div class="text-end pb-3">
											<span class="text-dark fw-bolder fs-5">$65.45</span>
											<span class="text-muted fs-7">/hr</span>
										</div>
										<!--end::Price-->
									</div>
								...
								<div class="p-0">
									...
									<div class="d-flex flex-column">
										<!--begin::Text-->
										<p class="text-gray-700 fw-bold fs-6 mb-4">Outlines keep you honest. They stop you from indulging.</p>
										<!--end::Text-->
										<!--begin::Tags-->
										<div class="d-flex text-gray-700 fw-bold fs-7">
											<!--begin::Tag-->
									...
									<div class="d-flex flex-column">
										...
										<div class="d-flex flex-stack">
											...
											<div class="d-flex flex-column mw-200px">
												<div class="d-flex align-items-center mb-2">
													<span class="text-gray-700 fs-6 fw-bold me-2">58%</span>
													<span class="text-muted fs-8">Job Success</span>
												</div>
												<div class="progress h-6px w-200px">
							...
							<div class="border border-hover-primary p-7 rounded mb-7">
								...
								<div class="d-flex flex-stack pb-3">
									...
									<div class="d-flex">
										...
										<div class="ms-5">
											<!--begin::Name-->
											<div class="d-flex align-items-center">
												<a href="../../demo1/dist/pages/user-profile/overview.html" class="text-dark fw-bolder text-hover-primary fs-5 me-4">Lusy Kunic</a>
												<!--begin::Label-->
												<span class="m-0"></span>
												<!--end::Label-->
											</div>
											<!--end::Name-->
											<!--begin::Desc-->
											<span class="text-muted fw-bold mb-3">DevOPs</span>
											<!--end::Desc-->
										</div>
										<!--end::Details-->
									</div>
									...
									<div clas="d-flex">
										<!--begin::Price-->
										<div class="text-end pb-3">
											<span class="text-dark fw-bolder fs-5">$60,45</span>
											<span class="text-muted fs-7">/hr</span>
										</div>
										<!--end::Price-->
									</div>
								...
								<div class="p-0">
									...
									<div class="d-flex flex-column">
										<!--begin::Text-->
										<p class="text-gray-700 fw-bold fs-6 mb-4">Long before you sit down to put digital pen to paper you need make sure you have to sit down and write.</p>
										<!--end::Text-->
										<!--begin::Tags-->
										<div class="d-flex text-gray-700 fw-bold fs-7">
											<!--begin::Tag-->
									...
									<div class="d-flex flex-column">
										...
										<div class="d-flex flex-stack">
											...
											<div class="d-flex flex-column mw-200px">
												<div class="d-flex align-items-center mb-2">
													<span class="text-gray-700 fs-6 fw-bold me-2">86%</span>
													<span class="text-muted fs-8">Job Success</span>
												</div>
												<div class="progress h-6px w-200px">
							...
							<div class="border border-hover-primary p-7 rounded">
								...
								<div class="d-flex flex-stack pb-3">
									...
									<div class="d-flex">
										...
										<div class="ms-5">
											<!--begin::Name-->
											<div class="d-flex align-items-center">
												<a href="../../demo1/dist/pages/user-profile/overview.html" class="text-dark fw-bolder text-hover-primary fs-5 me-4">Mat Dillon</a>
												<!--begin::Label-->
												<span class="m-0"></span>
												<!--end::Label-->
											</div>
											<!--end::Name-->
											<!--begin::Desc-->
											<span class="text-muted fw-bold mb-3">QA Managers</span>
											<!--end::Desc-->
										</div>
										<!--end::Details-->
									</div>
									...
									<div clas="d-flex">
										<!--begin::Price-->
										<div class="text-end pb-3">
											<span class="text-dark fw-bolder fs-5">$70,30</span>
											<span class="text-muted fs-7">/hr</span>
										</div>
										<!--end::Price-->
									</div>
								...
								<div class="p-0">
									...
									<div class="d-flex flex-column">
										<!--begin::Text-->
										<p class="text-gray-700 fw-bold fs-6 mb-4">First, a disclaimer - the entire process writing a blog post often takes more than couple of hours.</p>
										<!--end::Text-->
										<!--begin::Tags-->
										<div class="d-flex text-gray-700 fw-bold fs-7">
											<!--begin::Tag-->
									...
									<div class="d-flex flex-column">
										...
										<div class="d-flex flex-stack">
											...
											<div class="d-flex flex-column mw-200px">
												<div class="d-flex align-items-center mb-2">
													<span class="text-gray-700 fs-6 fw-bold me-2">70%</span>
													<span class="text-muted fs-8">Job Success</span>
												</div>
												<div class="progress h-6px w-200px">
